...
```bash
npx skills check CoboGlobal/cobo-agentic-wallet-python-sdk-python-sdk
```

If an update is available, run `npx skills update CoboGlobal/cobo-agentic-wallet-python-sdk-python-sdk`. Alternative: `npx clawhub@latest update --all`.
