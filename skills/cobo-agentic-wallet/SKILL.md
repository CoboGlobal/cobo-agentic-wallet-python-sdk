...
```bash
npx skills add CoboGlobal/cobo-agentic-wallet-python-sdk-python-sdk --list              # browse available skills
npx skills find CoboGlobal/cobo-agentic-wallet-python-sdk-python-sdk "<keyword>"        # or search by keyword
