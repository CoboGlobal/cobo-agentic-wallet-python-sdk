...
DeFi strategies are published as standalone skills. Use `caw schema` or `npx skills add CoboGlobal/cobo-agentic-wallet-python-sdk --list` to discover available skills.
