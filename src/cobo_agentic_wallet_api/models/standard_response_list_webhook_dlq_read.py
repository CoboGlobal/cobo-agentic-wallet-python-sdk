...
class StandardResponseListWebhookDLQRead(BaseModel):
    """
    StandardResponseListWebhookDLQRead
    """  # noqa: E501

    success: Optional[StrictBool] = True
    result: List[WebhookDLQRead]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandardResponseListWebhookDLQRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandardResponseListWebhookDLQRead from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": [WebhookDLQRead.from_dict(_item) for _item in obj["result"]]
