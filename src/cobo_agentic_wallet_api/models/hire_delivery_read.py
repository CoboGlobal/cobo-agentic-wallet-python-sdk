...
class HireDeliveryRead(BaseModel):
    """
    ...
    revision_notes: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HireDeliveryRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HireDeliveryRead from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "forwarded_to_client_at": obj.get("forwarded_to_client_at"),
