...
class NodeStatusRead(BaseModel):
    ...
    tss_node_id: Optional[StrictStr] = None
    online: Optional[StrictBool] = None
    signer: Optional[StrictBool] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodeStatusRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodeStatusRead from a dict"""
        if obj is None:
            return None
