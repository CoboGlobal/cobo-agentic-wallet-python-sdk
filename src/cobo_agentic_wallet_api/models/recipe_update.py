...
class RecipeUpdate(BaseModel):
    ...
    content_markdown: Optional[StrictStr] = None
    ...
    locale: Optional[Annotated[str, Field(strict=True, max_length=8)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecipeUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecipeUpdate from a dict"""
        if obj is None:
            return None
