...
class RecipeDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "content", "source", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecipeDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecipeDocument from a dict"""
        if obj is None:
            return None
