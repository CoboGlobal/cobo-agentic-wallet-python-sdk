...
class PrincipalUpdate(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(
        description="The new display name for this principal. Max 255 characters."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrincipalUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrincipalUpdate from a dict"""
        if obj is None:
            return None
