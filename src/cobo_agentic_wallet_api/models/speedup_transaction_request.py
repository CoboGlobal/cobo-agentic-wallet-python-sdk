...
class SpeedupTransactionRequest(BaseModel):
    """
    ...
    cobo_transaction_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None,
        description="The provider-side transaction ID of the transaction to speed up. Retrieve this from the original transfer or contract call response.",
    )
    __properties: ClassVar[List[str]] = ["request_id", "fee", "cobo_transaction_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpeedupTransactionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpeedupTransactionRequest from a dict"""
        if obj is None:
            return None
