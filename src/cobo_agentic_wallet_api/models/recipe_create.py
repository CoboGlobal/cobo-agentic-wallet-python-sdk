...
class RecipeCreate(BaseModel):
    ...
    auto_publish: Optional[StrictBool] = False
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecipeCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecipeCreate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("auto_publish") is not None
                else False,
            }
        )
        return _obj
