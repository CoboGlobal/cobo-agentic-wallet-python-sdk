...
class StandardResponseDictStrBool(BaseModel):
    """
    StandardResponseDictStrBool
    """  # noqa: E501

    success: Optional[StrictBool] = True
    result: Dict[str, StrictBool]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandardResponseDictStrBool from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandardResponseDictStrBool from a dict"""
        if obj is None:
            return None
