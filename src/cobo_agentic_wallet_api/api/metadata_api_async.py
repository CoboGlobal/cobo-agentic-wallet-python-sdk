...
class AsyncMetadataApi:
    ...
    @validate_call
    async def get_chain_info_by_chain_id_with_http_info(
        self,
        chain_id: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_chain_info_by_chain_id_without_preload_content(
        self,
        chain_id: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def list_chains_with_http_info(
        self,
        wallet_type: Annotated[
            Optional[WalletType],
            Field(description="The wallet type to retrieve chains for. Use `MPC`."),
    ...
    @validate_call
    async def list_chains_without_preload_content(
        self,
        wallet_type: Annotated[
            Optional[WalletType],
            Field(description="The wallet type to retrieve chains for. Use `MPC`."),
    ...
    @validate_call
    async def search_tokens_with_http_info(
        self,
        symbol: Annotated[
            str,
            Field(
    ...
    @validate_call
    async def search_tokens_without_preload_content(
        self,
        symbol: Annotated[
            str,
            Field(
