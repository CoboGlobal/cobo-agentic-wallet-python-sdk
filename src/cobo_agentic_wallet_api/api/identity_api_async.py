...
class AsyncIdentityApi:
    ...
    @validate_call
    async def create_principal_with_http_info(
        self,
        principal_create: PrincipalCreate,
        x_assistant_service_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def create_principal_without_preload_content(
        self,
        principal_create: PrincipalCreate,
        x_assistant_service_key: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_agent_status_with_http_info(
        self,
        agent_id: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def get_agent_status_without_preload_content(
        self,
        agent_id: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def list_principals_with_http_info(
        self,
        after: Annotated[
            Optional[StrictStr],
            Field(
    ...
    @validate_call
    async def list_principals_without_preload_content(
        self,
        after: Annotated[
            Optional[StrictStr],
            Field(
    ...
    @validate_call
    async def provision_agent_with_http_info(
        self,
        provision_request: ProvisionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def provision_agent_without_preload_content(
        self,
        provision_request: ProvisionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def update_principal_with_http_info(
        self,
        principal_id: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    async def update_principal_without_preload_content(
        self,
        principal_id: Annotated[
            StrictStr,
            Field(
