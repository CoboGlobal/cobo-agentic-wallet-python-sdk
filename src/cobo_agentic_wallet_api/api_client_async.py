...
from cobo_agentic_wallet_api.api_response import ApiResponse, T as ApiResponseT
import cobo_agentic_wallet_api.models
from cobo_agentic_wallet_api import rest_async
from cobo_agentic_wallet_api.auth.auth_helper import AuthHelper
...
class AsyncApiClient:
    ...
    This client handles the client-server communication asynchronously using aiohttp.
    ...
    def __init__(
        ...
        self.user_agent = "cobo-agentic-wallet-python-api/0.1.39"
    ...
    async def call_api(
        ...
        try:
            ...
            auth_headers = AuthHelper.generate_headers(api_key=self.configuration.api_key)
            header_params.update(auth_headers)
            if getattr(self.configuration, "service_auth_key", None):
                header_params["X-Assistant-Service-Key"] = self.configuration.service_auth_key
    ...
    def response_deserialize(
        self,
        response_data: rest_async.AsyncRESTResponse,
        response_types_map: Optional[Dict[str, ApiResponseT]] = None,
    ) -> ApiResponse[ApiResponseT]:
        """Deserializes response into an object.
        :param response_data: AsyncRESTResponse object to be deserialized.
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cobo_agentic_wallet_api.models, klass)

        if klass in self.PRIMITIVE_TYPES:
            return self.__deserialize_primitive(data, klass)
        elif isinstance(klass, object):
            return self.__deserialize_object(data)
        elif isinstance(klass, datetime.date):
            return self.__deserialize_date(data)
        elif isinstance(klass, datetime.datetime):
