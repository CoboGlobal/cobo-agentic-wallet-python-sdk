...
from cobo_agentic_wallet.errors import translate_api_exception
...
class WalletAPIClient(
    ...
    def __init__(
        ...
        *,
        ...
        # Translate generated ApiException into our APIError hierarchy at the single
        # chokepoint where the generated API methods raise on non-2xx responses.
        # This preserves structured denial bodies for PolicyDenial parsing.
        _original_response_deserialize = self._api_client.response_deserialize

        def _response_deserialize_translated(response_data, response_types_map=None):
            try:
                return _original_response_deserialize(response_data, response_types_map)
            except ApiException as exc:
                raise translate_api_exception(exc) from exc

        self._api_client.response_deserialize = _response_deserialize_translated
